...
var file_user_service_proto_rawDesc = []byte{
	...
	0x2e, 0x55, 0x73, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x32,
	0xce, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	...
	,
...
var file_user_service_proto_depIdxs = []int32{
	10, // 0: pb.User.type:type_name -> pb.UserType
	11, // 1: pb.User.created_at:type_name -> google.protobuf.Timestamp
	11, // 2: pb.User.updated_at:type_name -> google.protobuf.Timestamp
	10, // 3: pb.UserInfo.type:type_name -> pb.UserType
	12, // 4: pb.GetUsersRequest.context:type_name -> pb.Context
	1,  // 5: pb.GetUsersResponse.users:type_name -> pb.User
	12, // 6: pb.GetUserRequest.context:type_name -> pb.Context
	1,  // 7: pb.GetUserResponse.user:type_name -> pb.User
	12, // 8: pb.UpdateUserRequest.context:type_name -> pb.Context
	9,  // 9: pb.UpdateUserRequest.data:type_name -> pb.UpdateUserData
	10, // 10: pb.UpdateUserData.type:type_name -> pb.UserType
	13, // 11: pb.UserService.Hello:input_type -> pb.HelloRequest
	0,  // 12: pb.UserService.GetUserForAuth:input_type -> pb.GetUserForAuthRequest
	2,  // 13: pb.UserService.GetUserInfo:input_type -> pb.GetUserInfoRequest
	4,  // 14: pb.UserService.GetUsers:input_type -> pb.GetUsersRequest
	6,  // 15: pb.UserService.GetUser:input_type -> pb.GetUserRequest
	8,  // 16: pb.UserService.UpdateUser:input_type -> pb.UpdateUserRequest
	14, // 17: pb.UserService.Hello:output_type -> pb.HelloResponse
	1,  // 18: pb.UserService.GetUserForAuth:output_type -> pb.User
	3,  // 19: pb.UserService.GetUserInfo:output_type -> pb.UserInfo
	5,  // 20: pb.UserService.GetUsers:output_type -> pb.GetUsersResponse
	7,  // 21: pb.UserService.GetUser:output_type -> pb.GetUserResponse
	15, // 22: pb.UserService.UpdateUser:output_type -> pb.Empty
