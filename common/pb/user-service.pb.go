...
var file_user_service_proto_rawDesc = []byte{
	...
	0x75, 0x73, 0x65, 0x72, 0x32, 0x9c, 0x02, 0x0a, 0x0b, 0x55, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72,
...
var file_user_service_proto_goTypes = []interface{}{
	...
	(UserType)(0),                 // 8: pb.UserType
	(*timestamppb.Timestamp)(nil), // 9: google.protobuf.Timestamp
	(*Context)(nil),               // 10: pb.Context
	(*HelloRequest)(nil),          // 11: pb.HelloRequest
	(*HelloResponse)(nil),         // 12: pb.HelloResponse
}
var file_user_service_proto_depIdxs = []int32{
	8,  // 0: pb.User.type:type_name -> pb.UserType
	9,  // 1: pb.User.created_at:type_name -> google.protobuf.Timestamp
	9,  // 2: pb.User.updated_at:type_name -> google.protobuf.Timestamp
	8,  // 3: pb.UserInfo.type:type_name -> pb.UserType
	10, // 4: pb.GetUsersRequest.context:type_name -> pb.Context
	1,  // 5: pb.GetUsersResponse.users:type_name -> pb.User
	10, // 6: pb.GetUserRequest.context:type_name -> pb.Context
	1,  // 7: pb.GetUserResponse.user:type_name -> pb.User
	11, // 8: pb.UserService.Hello:input_type -> pb.HelloRequest
	0,  // 9: pb.UserService.GetUserForAuth:input_type -> pb.GetUserForAuthRequest
	2,  // 10: pb.UserService.GetUserInfo:input_type -> pb.GetUserInfoRequest
	4,  // 11: pb.UserService.GetUsers:input_type -> pb.GetUsersRequest
	6,  // 12: pb.UserService.GetUser:input_type -> pb.GetUserRequest
	12, // 13: pb.UserService.Hello:output_type -> pb.HelloResponse
	1,  // 14: pb.UserService.GetUserForAuth:output_type -> pb.User
	3,  // 15: pb.UserService.GetUserInfo:output_type -> pb.UserInfo
	5,  // 16: pb.UserService.GetUsers:output_type -> pb.GetUsersResponse
	7,  // 17: pb.UserService.GetUser:output_type -> pb.GetUserResponse
